...
<div class="container-fluid px-0">
		...
		<div class="mx-md-5 mx-0">
			<div class="row mb-3 px-2 mt-md-5 mt-4">
				<div class="col">
				<h4>Why do you want to come to dubai?</h4>
				</div>
			</div>
			<div class="row my-2 mx-2">
				<div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/smiley.png"> Lifestyle</button>
				</div>
				<div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/pic1.png"> Work opportunities</i></button>
				</div>
				<div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/notes.png"> Education</button>
				</div>
				<div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/jar.png"> Finance</button>
				</div>
				<div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/Tourism.png"> Tourism</button>
                </div>
                <div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/Family.png"> Family</button>
                </div>
                <div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/Business.png"> Business</button>
                </div>
				...
				<div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/cloud.png"> The weather</button>
                </div>
                <div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/meeting.png"> Meeting new people</button>
                </div>
                <div class="col-auto mb-3 px-1 py-2">
				<button class="btn w-100 px-4"><img class="pl-1" src="<?= base_url();?>assets/images/icons/culture.png"> Culture</button>
				</div>
